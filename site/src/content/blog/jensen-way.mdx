...
The repo is [agentoptics/jensen-way](https://github.com/agentoptics/jensen-way), MIT licensed. A few directions worth exploring if others find this useful:

- **Scorecard history** — track how your team's predictions age. How often did Pivot-grade decisions become Kill decisions six months later?
- **Integration with [Rewind](/)** — when an agent fails, re-run the original spec through Jensen Way to see if the failure was in execution or in the plan
- **Domain-specific law sets** — the six current laws are generic. Infra decisions probably want a "blast radius" law; consumer product decisions probably want a "retention gravity" law
