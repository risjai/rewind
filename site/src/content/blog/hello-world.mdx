...
1. **Direct mode** (Python): `rewind_agent.init()` monkey-patches OpenAI and Anthropic SDKs in-process. Negligible overhead since recording happens in-process with no network hop.
