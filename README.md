...
| **SQL Query Explorer** | Run ad-hoc SQL against the Rewind database. Token usage by model, average step duration, sessions with errors — read-only, safe to explore. | [sql-queries.md](docs/sql-queries.md) | — |
